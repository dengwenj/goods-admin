...
class LoginUI extends Component {
  ...
  //   if (this.props.userLoginData && this.props.userLoginData.id) {
  ...
  onFinish = async (values) => {
    ...
    // message.error(this.props.userLoginData.errorMsg)
    // this.setState({
    //   loading: false,
    //   text: '登录',
    // })
  ...
  render() {
    ...
    // 如果有用户已经登录，自动跳转到管理界面
    if (userLoginData && userLoginData.id) return <Redirect to="/home" />
    // 走下来了说明没有 userLoginData.id 表示没有登录成功
...
const Login = connect((state) => ({ userLoginData: state.userLoginData }), {
  login,
})(LoginUI)
